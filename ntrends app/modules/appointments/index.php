...
<head>
    ...
    <style>
        ...
        .bg-teal {
            background: linear-gradient(135deg, #20c997, #0cb285);
        }
        ...
        <div class="container-fluid px-4 pt-4">
                ...
                <div class="row mb-4">
                    <div class="col-md-6 col-lg-4 mb-3">
                        <div class="card dash-card bg-teal shadow-sm h-100">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div>
                                    <h6 class="text-uppercase mb-1">Open Today</h6>
                                    <h2 class="mb-0 fw-bold" id="countOpen">0</h2>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-3">
                        <div class="card dash-card bg-pink shadow-sm h-100">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div>
                                    <h6 class="text-uppercase mb-1">Closed/Done Today</h6>
                                    <h2 class="mb-0 fw-bold" id="countClosed">0</h2>
                                </div>
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-3">
                        <div class="d-flex align-items-center bg-white rounded border shadow-sm p-1">
                            <button class="btn btn-sm btn-light border-0 text-muted" onclick="changeDate(-1)"
                                title="Previous Day">
                            ...
                            <div class="d-flex align-items-center border-start border-end mx-1 px-2">
                                ...
                                <input type="date" id="dateFilter"
                                    class="form-control form-control-sm border-0 shadow-none fw-bold p-0 text-center"
                                    style="width: 110px; cursor: pointer;" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-5 position-relative">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="customerSearchInput" class="form-control form-control-lg"
                        ...
                        <div class="col-md-7">
                            <div id="selectedCustomerCard"
                                class="p-3 shadow-sm d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <div class="avatar-circle me-3"><i class="fas fa-user"></i></div>
                                    <div>
                                        <h5 class="mb-1 fw-bold" id="cardCustName">--</h5>
                                        <div class="text-muted mb-1"><i class="fas fa-phone-alt me-2"></i><span
                                                id="cardCustPhone">--</span></div>
            ...
            <div id="billingView" class="d-none">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="fw-bold text-primary"><i class="fas fa-cash-register me-2"></i>Edit Services / Billing
                    </h4>
                    ...
                    <div class="col-md-9">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-4 d-flex align-items-center border-end">
                                        <div class="avatar-circle me-3 bg-success text-white"
                                            style="width:50px; height:50px; font-size:20px;"><i class="fas fa-user"></i>
                                        </div>
                                        <div>
                                            <h5 class="mb-0 fw-bold" id="advCustName">Name</h5>
                                            <div class="text-muted" id="advCustPhone">--</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 border-end">
                                        ...
                                        <input type="date"
                                            ...
                                            id="advDate" value="<?php echo date('Y-m-d'); ?>">
                                    </div>

                                    <div class="col-md-3 border-end">
                                        <label class="small text-muted fw-bold">Discount (%)</label>
                                        <select class="form-select form-select-sm fw-bold border-primary text-primary"
                                            id="advDiscount" onchange="calculateGrandTotal()">
                                    ...
                                    <div class="col-md-3">
                                        <div class="text-end">
                                            ...
                                            <div class="small text-decoration-line-through text-muted" id="headerGross"
                                                style="display:none; font-size: 12px;">₹0.00</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card shadow-sm border-0">
                            <div
                                ...
                                <button class="btn btn-sm btn-success" onclick="addNewServiceRow()"><i
                                        class="fas fa-plus me-1"></i> Add Services</button>
                            </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card shadow-sm mb-3 border-top border-4 border-primary">
                            <div class="card-header bg-white fw-bold"><i
                                    class="fas fa-history me-2 text-primary"></i>History Stats</div>
                            <div class="card-body p-3 small">
                                <div class="d-flex justify-content-between mb-2 border-bottom pb-1"><span
                                        class="text-muted">Visits:</span><span class="fw-bold text-dark"
                                        id="histVisits">--</span></div>
                                <div class="d-flex justify-content-between mb-2 border-bottom pb-1"><span
                                        class="text-muted">Total Spent:</span><span class="fw-bold text-success"
                                        id="histSpent">₹0</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end mt-4 p-3 bg-white shadow-sm rounded">
                    <button type="button" class="btn btn-danger me-2 px-4" onclick="closeBillingView()"><i
                            class="fas fa-times me-2"></i> Cancel</button>
                    <button type="button" class="btn btn-success px-5" id="btnSaveBooking"
                        onclick="saveAdvancedBooking()"><i class="fas fa-save me-2"></i> Save Changes</button>
                </div>
            </div>
                    ...
                    <form id="apptForm">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6"><label class="form-label">Date</label><input type="date"
                                    class="form-control" name="appointment_date" id="apptDate" required
                                    value="<?php echo date('Y-m-d'); ?>"></div>
                            <div class="col-md-6"><label class="form-label">Time</label><input type="time"
                                    class="form-control" name="appointment_time" id="apptTime" required></div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6"><label class="form-label">Name</label><input type="text"
                                    class="form-control" name="client_name" id="clientName" required></div>
                            <div class="col-md-6">
                                <label class="form-label">Phone</label>
                                <input type="tel" class="form-control" name="client_phone" id="clientPhone"
                                    pattern="[0-9]*" inputmode="numeric">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6"><label class="form-label">Gender</label><select class="form-select"
                                    name="gender" id="clientGender" required>
                                    <option value="Male">Male</option>
                                    <option value="Female">Female</option>
                                </select></div>
                            <div class="col-md-6"><label class="form-label">Type</label><select class="form-select"
                                    name="client_type" id="clientType" required>
                        ...
                        <div class="d-grid text-end"><button type="submit" class="btn btn-primary px-5"
                                id="submitBtn">Confirm Booking</button></div>
                    </form>
                </div>
            </div>
        </div>
